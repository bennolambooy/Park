import {controleerToegang, isIngelogd, uitloggen} from './github.js?v=20260916-4';
...
export async function toegang() {
  if (sessionStorage.getItem('park-toegang') !== 'open' && !isIngelogd()) {
    ...
    gate.innerHTML = '<section class="panel login"><img src="woordbeeld-groen.png" width="144" alt="het Park">' +
      '<h1 style="font-size:30px;margin-top:24px">Handtekeningen</h1><p class="muted">Vul het Park-wachtwoord in om verder te gaan.</p>' +
